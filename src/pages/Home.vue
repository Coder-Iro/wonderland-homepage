<template>
  ...
  <article>
    <youtube-iframe :player-parameters="{
      listType: 'playlist',list:'PL-kUY2NcroAxDrAnUyEaeog7BX8Qj52uh'
    }" no-cookie player-height="390" player-width="640" video-id="PgIzZfS9RP0"/>
    <div class="bar"/>
    <div class="info">
      ...
      <div class="section">
        <div class="box box-alert">
          ...
          <div class="str"><br>
            <strong class="red"># Wonderland Server Season II 정식 업데이트</strong><br>
            <br>
            - 서버 웹사이트가 리뉴얼 되었습니다.<br>
            <br>
            - 서버 로고가 변경됐습니다.<br>
            <br>
            - 서버 웹사이트 아이콘이 변경됐습니다.<br>
            <br>
            - 명령어가 시즌2에 맞게 안내됩니다.<br>
            <br>
            - 컨텐츠 사전에 대부분의 컨텐츠 설명이 업데이트 됐습니다.<br>
            <br>
            - 디스코드 메뉴가 추가됐습니다.<br>
            <br>
      ...
      <div class="section">
        <div class="box">
          ...
          <dl>
            ...
            <dd><strong class="green">CPU</strong> Intel Xeon E3-1230 3.30 GHz</dd>
            <dd><strong class="green">RAM</strong> 18GB <strong class="green">HDD</strong> 500GB</dd>
          </dl>
          <dl>
            <dt>접속주소</dt>
          ...
          <dl>
            <dt>장르</dt>
            <dd>스토리 RPG / 경제 / 야생 / 건축 / PvP / 미니게임</dd>
          </dl>
          <dl>
            <dt>접속허용</dt>
            <dd>정품만 가능</dd>
          ...
          <dl>
            <dt>월드</dt>
            <dd>Prologue, Wonderland, Normaland, Coma</dd>
          </dl>
          <dl>
            <dt>PvP</dt>
            <dd>PvP 구역에서만 가능</dd>
      ...
      <div class="section">
        <div class="box">
          ...
          <ul>
            ...
            <li>죽었을 때 소지품과 경험치를 잃어버리지 않음</li>
            ...
            <li><span class="green">에메랄드</span>를 화폐로 사용하며, 은행계좌 사용 가능</li>
            <li>파티플레이 지원</li>
            <li>치트/테러 방지 시스템 사용</li>
            <li>레벨에 따라 능력치가 증가하는 성장 시스템</li>
            <li><span class="red">비 / 눈</span> 이 내리지 않으며 <span class="red">눈 / 얼음</span> 이 녹지 않음</li>
      ...
      <div class="section">
        <div class="box">
          ...
          <ul>
            ...
            <li>매주 월요일마다 최신버전의 맵으로 리셋되는 <span class="red">Coma</span> 월드 존재</li>
            <li>청크(16x16) 별로 토지 구매 가능한 부동산 시스템</li>
            <li>월드에딧 처럼 자동건축을 도와주는 시스템 존재</li>
            <li>다양한 능력을 가진 무기/방어구 아이템 존재</li>
            <li>2시간마다 열리는 퀴즈 이벤트 참여 가능</li>
            <li>34종에 이르는 어류가 포함된 특수 낚시 시스템 존재</li>
